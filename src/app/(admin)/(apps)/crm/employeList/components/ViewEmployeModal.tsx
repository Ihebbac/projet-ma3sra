...
const ViewEmployeModal = ({ show, onHide, employe }: ViewEmployeModalProps) => {
  // Convertir les dates travaillées en objets Date
    ...
    <Modal show={show} onHide={onHide} size="lg" centered>
      ...
      <Modal.Body>
        ...
        <Row className="g-3 mb-3">
          ...
          <Col md={6}><strong>Prénom :</strong> {employe.prenom}</Col>
          <Col md={6}><strong>Téléphone :</strong> {employe.numTel}</Col>
        ...
        {Object.entries(groupedByMonth).map(([mois, dates], idx) => {
          ...
          return (
            <div key={idx} className="mb-5">
              <h5 className="mb-3">
                📅 {new Date(annee, m - 1).toLocaleString('fr-FR', {
                  month: 'long',
                  year: 'numeric'
                })}
              </h5>
